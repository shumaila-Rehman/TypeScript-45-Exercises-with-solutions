...
//comment to each. If you don’t have anything specific to write
...
let name1 : string = "shumaiola" // my name is shumaila   =====> its a comment
let date : string = "20/4/2024" // its a date ====> it is also a comment.
