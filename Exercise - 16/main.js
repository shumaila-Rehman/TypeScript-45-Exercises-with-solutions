...
var gustList = ["ali", "bilal", "aehmad", "fakhir"];
//   making variable for a person who is not coming.
var unableToCome = gustList[0];
...
gustList.forEach(function (newOne) { return console.log("hello ".concat(newOne, " , I found a bigger table , that's why i invite to all")); });
