...
//   making an array..
let  countryTour : string[] = ["China", "Japan", "Norway", "America"];

//  print array name.
console.log("original order: ", countryTour);

// now in alphabatical order.. //     [...string] ===> this is use for copy of variable 
console.log("Alphabetical order:", [...countryTour].sort()); // sort method for alphabateical
...
console.log("reverse order :", [...countryTour].reverse());
...
console.log("back to original form again reverse it to convert in original form", 
countryTour.reverse());
